...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{A Classical Theorem, but in Intuitionism}, opacitybacktitle=0.6, breakable, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, coltitle=black, arc=.35mm, titlerule=0mm, bottomtitle=1mm, rightrule=.15mm, toptitle=1mm, opacityback=0, colback=white, colframe=quarto-callout-tip-color-frame]
